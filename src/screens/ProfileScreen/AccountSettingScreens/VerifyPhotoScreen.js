...
const VerifySelfie = ({ navigation }) => {
    ...
    const uploadPhoto = async (uri) => {
        ...
        try {
            ...
            const response = await axios.post('file/upload-private', formData, {
                headers: {
                    Authorization: token,
    ...
    const submitSelfie = async () => {
        ...
        console.log('paload of selfie verification', payload);
            ...
            {!selfie && (
                <TouchableOpacity onPress={handleTakeSelfie}>
                    <View style={styles.cont5}>
                        <Text style={styles.txt10}>Take Selfie</Text>
                    </View>
                </TouchableOpacity>
            )}
