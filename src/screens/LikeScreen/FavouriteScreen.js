...
const FavouriteScreen = ({ navigation }) => {
    ...
    const getViewMeData = async (page = 0) => {
        ...
        try {
            const resp = await axios.post(`home/get-favorite/favorites/${userId}`, body, { headers });
            console.log('Response from the favourites me data:', resp.data.data);
            ...
            console.error('Error from get favourites data:', error);
        } finally {
    ...
    const renderFavourite = ({ item }) => (
        <View style={styles.card}>
            ...
            <View style={styles.actionRow}>
                ...
                <TouchableOpacity style={{ borderWidth: 1, borderColor: '#916008', borderRadius: 100, height: 36, width: 36, justifyContent: 'center', backgroundColor: '#916008' }}>
                    <Image source={images.heart} style={[styles.icon, { tintColor: 'white' }]} />
                </TouchableOpacity>
            </View>
        </View>
    );
