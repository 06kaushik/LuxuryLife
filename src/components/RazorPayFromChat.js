    ...
    const createSubscription = async (planType) => {
        ...
        try {
            ...
            try {
                ...
                console.error('Error creating subscription (API Call):', error?.response?.data?.message || error?.message);
            ...
            <Modal isVisible={isModalVisible} style={styles.modal}>
                <View style={styles.overlay}>
                    ...
                    <View style={styles.modalContent}>
                        ...
                        <TouchableOpacity onPress={() => { navigation.goBack(''); setIsModalVisible(false) }}>
                            <View style={styles.submitButton}>
                                <Text style={styles.submitText}>Back To Chat</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                </View>
...
export default RazorPayGatewayChat;
